...
window.onload = function defineCalendar() {
  ...
  var updatedValue = document.getElementById("calendar-attached");
  myCalender.onValueChange(function (currentValue) {
    updatedValue.nodeValue = currentValue.getFullYear() + "-" + (currentValue.getMonth() + 1) + "-" + currentValue.getDate();
...
/******/ });
//# sourceMappingURL=application-38563438d24d13a36b17.js.map