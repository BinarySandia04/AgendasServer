...
window.onload = function defineCalendar() {
  ...
  myCalender.onValueChange(function (currentValue) {
    updatedValue.setAttribute("value", currentValue.getFullYear() + "-" + (currentValue.getMonth() + 1) + "-" + currentValue.getDate());
...
/******/ });
//# sourceMappingURL=application-a67e7e775fb31165157e.js.map